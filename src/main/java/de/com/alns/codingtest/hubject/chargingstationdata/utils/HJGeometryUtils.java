...
public class HJGeometryUtils {
    ...
    public static Point convertDoublesToJtsGeometry(Double pLatitude, Double pLongitude) {
        return convertPointLocationDTOToJtsGeometry(new PointLocationDTO(pLatitude, pLongitude));
    }
